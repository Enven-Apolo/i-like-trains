...
document.getElementById("playerQuestion").innerHTM = "Turno de Pergunta - " + player1Name ;
document.getElementById("playerAnswer").innerHTM = "Turno de Resposta - " + player2Name ;
